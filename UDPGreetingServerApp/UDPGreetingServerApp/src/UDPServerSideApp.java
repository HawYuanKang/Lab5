	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	while (true) {
	            ...
	            byte[] outData1 = processor.convertToByteArray(totalVowel);
	            
	            int totalConsonent=processor.CountConsonent();
	            byte[] outData2 = processor.convertToByteArray(totalConsonent);
	            
	            int totalPunctuation=processor.CountPunctuation();
	            byte[] outData3 = processor.convertToByteArray(totalPunctuation);
	            ...
	            System.out.println("Message sent (totalConsonent) : " 
	            		+ totalConsonent  + ".\n");
